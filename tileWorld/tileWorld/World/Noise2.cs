...
namespace tileWorld
{  
    static public class Noise2
    {
        #region PerlinNoise Veriables
        private const int GradientSizeTable = 256;
        private static Random _random;
        private static readonly double[] _gradients = new double[GradientSizeTable * 3];
        ...
        private static readonly byte[] _perm = new byte[] {
        ...
        private static  double Lattice(int ix, int iy, int iz, double fx, double fy, double fz)
        {
